    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('home')}}">Car Care Admin</a>
            </div>
                       <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="{{url('home')}}"><i class='fa fa-home fa-1x'></i> Dashboard</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="bootstrap-elements.html"><i class='fa fa-truck fa-1x'></i> Check car</a>
                    </li>
                    <li>
                        <a href="bootstrap-grid.html"><i class='fa fa-fax fa-1x'></i>  Contact</a>
                    </li>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class='fa fa-group fa-1x'></i> Customer Profile</a>
                       
                    </li>
                    <li>
                        <a href="blank-page.html"><i class='fa fa-shopping-cart fa-1x'>
                     </i>  Promotion</a>
                    </li>
                </ul>
            </div>
